...
class ButtonState extends ChangeNotifier {
  ...
  void selectButton() {
    color = color == Colors.white ? const Color(dart_green) : Colors.white; // Thay đổi màu button
            ...
            child: Column(
              ...
              children: [
                                ...
                                child: ElevatedButton.icon(
                                  onPressed: () {
                                    setState(() {
                                      selectedTap = true;
                                      selectedTap1 =false;
                                      if (selectedTap == true && selectedTap1 == false){
                                  ...
                                  label: const Text('Xe tự lái',style: TextStyle(fontSize: 16),),
                                ...
                                child: ElevatedButton.icon(
                                  onPressed: () {
                                    setState(() {
                                      selectedTap = false;
                                      selectedTap1 =true;
                                      if (selectedTap == false && selectedTap1 == true){
                                  ...
                                  label: const Text('Xe có tài xế',style: TextStyle(fontSize: 16)),
                                  style: ElevatedButton.styleFrom(
                                    minimumSize: const Size.fromHeight(50),
                                    foregroundColor: Colors.black,
                ...
                const Padding(
                  ...
                  child: Text('Chương trình khuyến mãi',
                    style: TextStyle(
                        fontSize: 22,
                ...
                const Padding(
                  ...
                  child: Text('Xe dành cho bạn', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold),),
                ),
                //Item xe
                Container(
                  height: 500,
                ...
                const Padding(
                  padding: const EdgeInsets.only(left: 16),
                  child: Text('Địa điểm nổi bật', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold),),
                ),
                Container(
                  height: 300,
                  width: double.infinity,
                        ...
                        children: [
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              image: DecorationImage(
                                image: AssetImage('assets/images/thuduc.jpg'),
                          ...
                          Container(
                            ...
                            child: Padding(
                              ...
                              child: Text('TP. Thủ Đức', style: TextStyle(
                                fontSize: 20,
                                color: Colors.white,
                                fontWeight: FontWeight.bold
                              ),),
                      ...
                      Stack(
                        children: [
                          ...
                          Container(
                            ...
                            child: Padding(
                              padding: const EdgeInsets.only(top: 240.0, left: 16),
                              child: Text('Quận 10', style: TextStyle(
                                  fontSize: 20,
                                  color: Colors.white,
                                  fontWeight: FontWeight.bold
                              ),),
                        ...
                        children: [
                          Container(
                            ...
                            decoration: BoxDecoration(
                                ...
                                borderRadius: BorderRadius.circular(20),
                                image: DecorationImage(
                                    image: AssetImage('assets/images/binhthanh.jpg'),
                                    fit: BoxFit.fitHeight
                                )
                            ),
                          ),
                          Container(
                            ...
                            child: Padding(
                              padding: const EdgeInsets.only(top: 240.0, left: 16),
                              child: Text('Quận Bình Thạnh', style: TextStyle(
                                  fontSize: 20,
                                  color: Colors.white,
                                  fontWeight: FontWeight.bold
                              ),),
                        ...
                        children: [
                          Container(
                            ...
                            decoration: BoxDecoration(
                                ...
                                borderRadius: BorderRadius.circular(20),
                                image: DecorationImage(
                                    image: AssetImage('assets/images/quan1.jpg'),
                                    fit: BoxFit.fitHeight
                                )
                            ),
                          ),
                          Container(
                            ...
                            child: Padding(
                              padding: const EdgeInsets.only(top: 240.0, left: 16),
                              child: Text('Quận 1', style: TextStyle(
                                  fontSize: 20,
                                  color: Colors.white,
                                  fontWeight: FontWeight.bold
                              ),),
                ...
                const Padding(
                  padding: const EdgeInsets.only(left: 16),
                  child: Text('Ưu điểm của Mioto', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold),),
                ),
                Container(
                  height: 160,
                                ...
                                Column(
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      child: const Text('Lái xe an toàn cùng Mioto'
                                        ,style: TextStyle(
                                            fontSize: 18,
                                            fontWeight: FontWeight.bold
                                        ),),
                                    ...
                                    Container(
                                      ...
                                      width: 280,
                                      child: const Text('Chuyến đi trên Mioto được bảo vệ với gói bảo'
              ...
              children: [
                ...
                SizedBox(
                  child: RichText(
                    ...
                    text: TextSpan(
                        children: <TextSpan>[
                          TextSpan(text: widget.car['price'] + 'K', style: TextStyle(color: Color(dart_green), fontSize: 22, fontWeight: FontWeight.bold)),
          ...
          children: [
            ...
            Padding(
              ...
              child: ElevatedButton(
                ...
                style: ButtonStyle(
                  backgroundColor: MaterialStateProperty.all(const Color(dart_green)),
                  foregroundColor: MaterialStateProperty.all(Colors.white), // Đặt màu chữ và icon
                ...
                child: const Text('Tìm xe', style: TextStyle(fontSize: 20),),
              ),
            ),
          ],
        ),
